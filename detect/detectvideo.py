...
# Video yolunu yükle
video_path = "inference/uzi.mp4"  # GÖRSELİN YOLUNU DÜZENLE !
...
# Yeni boyut (640x480 olarak sabitliyoruz)
target_width = 1080
target_height = 700
...
while True:
    ...
    # Videoyu yeniden boyutlandır (640x480'e)
...
writer = cv2.VideoWriter(save_path,
                         ...
                         int(avg_fps),
                         (target_width, target_height))  # Yeni boyutu kaydetme
